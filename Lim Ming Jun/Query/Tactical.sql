...
GROUP BY TO_CHAR(TO_DATE(EXTRACT(MONTH FROM A.AttendanceDate), 'MM'), 'MONTH'), J.JobID, J.JobPosition, E.EmployeeID, E.EmployeeName, A.AttendanceDate, A.Check_In_Time
...
SELECT MONTH, JOB_TYPE, EMPLOYEE_ID, EMPLOYEE_NAME, ATTEND_DATE, CHECKINTIME
FROM VIEWL_ATE_EMP;
